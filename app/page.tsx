    ...
    try {
      ...
      if (exportType === 'monthly') {
        ...
        const rows = dailySales.map(day => [
          ...
          String(day.groups),
          String(day.firstTimeGuests),
          String(day.returnGuests),
          String(day.regularGuests),
        ...
        const totals = dailySales.reduce((acc, d) => ({
          ...
          firstTimeGuests: acc.firstTimeGuests + d.firstTimeGuests,
          returnGuests: acc.returnGuests + d.returnGuests,
          regularGuests: acc.regularGuests + d.regularGuests,
        ...
        }), { sales: 0, orderCount: 0, groups: 0, firstTimeGuests: 0, returnGuests: 0, regularGuests: 0, cashSales: 0, cardSales: 0, otherSales: 0, dailyPayment: 0, expenseDeposit: 0, expense: 0, cashCollection: 0, baseSales: 0 })
        ...
        rows.push([
          ...
          String(totals.firstTimeGuests),
          String(totals.returnGuests),
          String(totals.regularGuests),
          ...
          <div style={{ maxHeight: '200px', overflowY: 'auto' }}>
            {askItems.map((item, i) => (
              <div key={i} style={{
                ...
                <button
                  onClick={() => router.push(`/receipts?order=${item.orderId}`)}
